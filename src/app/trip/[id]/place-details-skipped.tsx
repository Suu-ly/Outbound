...
const PlaceDetailsSkipped = memo(
  forwardRef<HTMLDivElement, PlaceDetailsSkippedProps>(({ data }, ref) => {
      ...
      >
        <div className="flex items-start">
          ...
          <div className="min-w-0 grow xl:min-h-24">
            ...
            <Button
              className="mt-3 hidden h-9 w-full justify-start gap-1.5 rounded-lg pr-2 text-sm ring-offset-white has-[>div>svg,>svg]:pl-1.5 xl:inline-flex [&_svg]:text-slate-600 hover:[&_svg]:text-slate-700"
              size="small"
              variant="ghost"
            >
              <IconHeartShare />
