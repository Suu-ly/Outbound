          ...
          (variant === undefined ||
            ...
            <span
              ...
              className={cn(
                ...
                `clip-100 group-hover:clip-0 pointer-events-none absolute -inset-px m-0 size-auto border-0 ${primaryBgColor} text-gray-100 transition-all duration-300 ease-snap hover:text-gray-100`,
              )}
            >
              {children}
            </span>
