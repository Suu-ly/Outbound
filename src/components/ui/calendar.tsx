  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_grid: "w-full border-separate border-spacing-y-0.5",
        weekday:
          "text-slate-500 rounded-full w-9 sm:w-10 font-normal text-sm pb-1",
        day: "group text-center transition-all text-sm relative aria-selected:bg-slate-100 first:aria-selected:rounded-l-full last:aria-selected:rounded-r-full focus-within:relative focus-within:z-20",
        day_button:
          "inline-flex items-center justify-center text-slate-700 font-medium hover:text-slate-900 whitespace-nowrap rounded-full hover:bg-slate-100 transition size-8 sm:size-9 group-[.highlight]:!bg-brand-600 group-[.highlight]:hover:!bg-brand-600/90 group-[.highlight]:!text-gray-50 group-[.highlight]:hover:!text-gray-50 group-[.middle]:hover:bg-slate-200 group-[.today]:bg-brand-100 group-[.today]:hover:bg-brand-200 group-[.today]:text-brand-700 group-[.today]:hover:text-brand-900 ring-offset-white active:ring-slate-200 active:ring-2 active:ring-offset-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 disabled:text-slate-400 disabled:font-normal disabled:pointer-events-none disabled:opacity-70",
