  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "group text-center transition-all text-sm p-1 relative aria-selected:bg-slate-100 first:aria-selected:rounded-l-full last:aria-selected:rounded-r-full focus-within:relative focus-within:z-20",
        day_button:
